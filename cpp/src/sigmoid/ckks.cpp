...
std::vector<double> coeff_val({1,   0.6349347497444793,      0.0, -0.207226910968973,      0.0, 0.11926554318627501,
...
std::vector<double> coeff_val3({-9.751288354472837e-05, 0.0, 7.587595780529826e-05,  0.0, -5.903178548385316e-05,  0.0,
...
void SigmoidCKKS::eval() {
    ...
    temp1 =
        m_cc->EvalMult(m_cc->EvalMult(m_InputC, (double)(coeff * 32 * 4) / (pow(25, 3))), m_cc->EvalSquare(m_InputC));
