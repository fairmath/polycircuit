...
std::vector<double> coeff_val(
        {1, 0.6349347497444793, 0.0, -0.207226910968973, 0.0, 0.11926554318627501, 0.0, -0.08013715047239724, 0.0,
         0.05757992161586102, 0.0, -0.04280910730211544, 0.0, 0.03243169753850008, 0.0, -0.024837099847818355, 0.0,
         0.01914266900321147, 0.0, -0.014810271063030017, 0.0, 0.011484876770357881, 0.0, -0.008918658212582378, 0.0,
         0.006931783590193362, 0.0, -0.00539036659534493, 0.0, 0.004193061697765822, 0.0, -0.0032623449132251907, 0.0,
         0.0025385228671728505, 0.0, -0.0019754432169236547, 0.0, 0.001537332438236821, 0.0, -0.00119641841400218, 0.0,
         0.0009311199764515702, 0.0, -0.0007246568620069462, 0.0, 0.0005639769377601768, 0.0, -0.00043892561744415164,
         0.0, 0.00034160150542931166, 0.0, -0.00026585589670811906, 0.0, 0.00020690371892740422, 0.0,
         -0.00016102095964053078, 0.0, 0.0001253092833997599
        });

//These are the remaining values
std::vector<double> coeff_val3({
                                       -9.751288354472837e-05, 0.0, 7.587595780529826e-05, 0.0, -5.903178548385316e-05,
                                       0.0, 4.591638974071583e-05, 0.0, -3.570132724330664e-05, 0.0,
                                       2.7741357204113592e-05, 0.0, -2.15336836799884e-05, 0.0, 1.668619567482025e-05,
                                       0.0, -1.2892699205061372e-05, 0.0, 9.91357617352584e-06, 0.0,
                                       -7.560648875376369e-06
                               });
...
void SigmoidCKKS::eval() {
    ...
    temp1 = m_cc->EvalMult(m_cc->EvalMult(m_InputC, (double) (coeff * 32 * 4) / (pow(25, 3))),
    ...
    for (int i = 0; i < 6; i++) {
        ...
        prod = m_cc->EvalMult(m_cc->EvalMult(m_InputC, (double) (32 * coeff * 4 * pow(0.04, 3))),
                              m_cc->EvalSquare(m_InputC));
...
void SigmoidCKKS::serializeOutput() {
