...
class LookupTable final : public IComponent
{
public:
    explicit LookupTable(lbcrypto::CryptoContext<ElementType>&& cc,
    ...
    { }
    explicit LookupTable(const lbcrypto::CryptoContext<ElementType>& cc,
