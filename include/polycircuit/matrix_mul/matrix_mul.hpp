...
#pragma omp parallel sections
                {
#pragma omp section
                    m_MatrixAC = m_cc->EvalAdd(m_MatrixAC,
                                               m_cc->EvalRotate(m_MatrixAC, -m_matrixSize * m_matrixSize + 1));
#pragma omp section
                    m_MatrixBC =
                            m_cc->EvalAdd(m_MatrixBC,
                                          m_cc->EvalRotate(m_MatrixBC, -m_matrixSize * m_matrixSize + m_matrixSize));
                }
